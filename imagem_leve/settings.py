"""
Django settings for imagem_leve project.
...
SECRET_KEY = (
    'django-insecure-k1d87@@@j@r=cvjbkvj!bofr(dlxz1pbvmauy!p@oax(efno_4'
)
...
WSGI_APPLICATION = 'imagem_leve.wsgi.application'
